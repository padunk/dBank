...
export function Dapp() {
  ...
  let _token, _provider, _pollDataInterval: NodeJS.Timeout | undefined
    ...
    <div className='container p-4'>
      ...
      <div className='row'>
        <div className='col-12'>
          ...
          {state.balance.gt(0) && (
            <Transfer
              transferTokens={(to: string, amount: number) =>
  ...
  // send a transaction.
  async function _transferTokens(to: string, amount: number) {
  ...
  // message.
  function _getRpcErrorMessage(error: Error) {
    if (error.data) {
